    ...
    <div class="row col-sm-12">
        <div class="box" style="min-height: 400px;">
            <div class="box-header">
                ...
                <div class="box-tools">
                    <form class="input-group input-group-sm pull-right" style="width:350px;" method="post" action="{{route('cervejas.filtro')}}">
                    {{ csrf_field() }}
                    <div class="input-group-btn">
                            <a href="{{ route('cervejas.create') }}" class="btn btn-success" role="button"> Novo </a>
                        <a href='{{route('cervejas.index')}}' class='btn btn-primary' role='button'> Ver Todos </a>
                     </div>
            ...
            <div class="box-footer">{{ $cervejas->links() }}</div>
        </div>
