...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        language: 'en',
        stars: 5,
        filledStar: '<i class="fa fa-beer text-yellow"></i>',
        emptyStar: '<i class="fa fa-beer"></i>',
        containerClass: '',
        size: 'md',
        animate: true,
        displayOnly: false,
    ...
    $.fn.ratingLocales.en = {
        defaultCaption: '{rating} Canecas',
        starCaptions: {
            0.5: 'Meia Caneca',
            1: 'Uma Caneca',
            1.5: 'Uma Caneca e Meia',
            2: 'Duas Canecas',
            2.5: 'Duas Canecas e Meia',
            3: 'Três Canecas',
            3.5: 'Três Canecas e Meia',
            4: 'Quatro Canecas',
            4.5: 'Quatro Canecas e Meia',
            5: 'Cinco Canecas'
        },
